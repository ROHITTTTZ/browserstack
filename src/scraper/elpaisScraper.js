/**
 * EL PAÍS Web Scraper - Professional Content Extraction
 * Features:
...
/**
 * Opens EL PAÍS homepage and waits for page load
...
/**
 * Handles cookie consent popup by accepting all cookies
 * @param {WebDriver} driver - Selenium WebDriver instance
 */
...
/**
 * Gets the first 5 articles from Opinion section
 * @param {WebDriver} driver - Selenium WebDriver instance
 * @returns {Array} Array of article URLs
 * @throws {Error} If article extraction fails
 */
...
/**
 * Extracts detailed information from a single article
 * @param {WebDriver} driver - Selenium WebDriver instance
 * @param {string} articleUrl - URL of the article to extract
 * @param {number} index - Index of the article (for logging)
 * @returns {Object} Article details including title, content, image URL, and type
 * @throws {Error} If article extraction fails
 */
 ...
 * @param {WebDriver} driver - Selenium WebDriver instance
 * @returns {string} Extracted content or error message
 */
